...
### Changes
- Skills: add GoHighLevel (GHL) skill for contacts, pipelines/opportunities, conversations, calendars, and workflow enrollment via API v2, plus a chat menu pattern for driving GHL actions from a conversation.
